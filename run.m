...
carbon_ratio = 1.0; % C dumped per O dumped

diffusion_constant_per_compartment2 = 0.75; % input diffusion constant
fixed_oxygen_level = 75.0;  % oxygen level at thermocline
fixed_oxygen_diffusion = 1e4;   % diffusion from oxygen above the thermocline
